import itertools
import SeiraRobot.modules.sql.language_sql as sql
...
from SeiraRobot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from SeiraRobot.language import get_string, get_languages, get_language
    ...
    keyb.append(
        [
            InlineKeyboardButton(
                text="Botညီလေး With Love 💜 ",
                url="https://t.me/n4nd4_hippy_bot",
            )
        ]
    )
